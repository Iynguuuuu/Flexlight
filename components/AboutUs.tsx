                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[90%] 
                    ...
                    <div className='text-center p-[1rem]'>
                        ...
                        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative 
                                w-[300px] h-[300px] md:h-[300px] mx-auto '>
                            <Image src="/images/u1.png" alt="AboutUs" layout='fill' className='object-contain fixed rounded-full' />
                        </div>
                    ...
                    <div className='text-center p-[1rem]'>
                        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative 
                                w-[300px] h-[300px] md:h-[300px] mx-auto '>
                            <Image src="/images/u2.png" alt="AboutUs" layout='fill' className='object-contain fixed rounded-full' />
                        </div>
                        <h1 className='text-[20px] mt:text-[10px] mt-[5px] mb-[5px] font-semibold'>
                    ...
                    <div className='text-center p-[1rem]'>
                        ...
                        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative 
                                w-[300px] h-[300px] md:h-[300px] mx-auto '>
                            <Image src="/images/me.png" alt="AboutUs" layout='fill' className='object-contain fixed rounded-full' />
                        </div>
                        <h1 className='text-[20px] mt:text-[10px] mt-[5px] mb-[5px] font-semibold'>
                    ...
                    <div className='text-center p-[1rem]'>
                        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative 
                                w-[300px] h-[300px] md:h-[300px] mx-auto '>
                            <Image src="/images/u3.png" alt="AboutUs" layout='fill' className='object-contain fixed rounded-full' />
                        </div>
                        <h1 className='text-[20px] mt:text-[10px] mt-[5px] mb-[5px] font-semibold'>
                            Abdul Adeel <br />
                            <span className='text-18 font-normal'>Member</span>
                    ...
                    <div className='text-center p-[1rem]'>
                        <div className='transform cursor-pointer hover:-translate-y-6 transition-all duration-200 relative 
                                w-[300px] h-[300px] md:h-[300px] mx-auto '>
                            <Image src="/images/u4.png" alt="AboutUs" layout='fill' className='object-contain fixed rounded-full' />
                        </div>
                        <h1 className='text-[20px] mt:text-[10px] mt-[5px] mb-[5px] font-semibold'>
